...
class EnetData:
    ...
    def get_value_template_from_input_device_function(self, type_id: str) -> list:
        ...
        return self.get_value_template_from_value_container(
            function_type.get("valueTypeContainerTypeID")
        )
    ...
    def get_output_device_function_name(self, type_id: str) -> str:
        ...
        return self.get_output_device_function_type_by_id(type_id).get(
            "name", "Unknown"
        )
    ...
    def get_value_template_from_value_container(self, type_id: str) -> list:
        ...
        for value_type_id in value_container.get("valueTypeIDs", []):
            value_template.append(
                self.get_value_template_from_value_type(value_type_id)
            )
    ...
    async def import_device_function_types(self) -> None:
        ...
        self._input_device_function_types = self.parse_list_to_dict(
            json_data["inputDeviceFunctionTypes"], "id"
        )
        self._output_device_function_types = self.parse_list_to_dict(
            json_data["outputDeviceFunctionTypes"], "id"
        )
    ...
    async def import_device_parameter_types(self) -> None:
        ...
        self._device_parameter_types = self.parse_list_to_dict(
            json_data["deviceParameterTypes"], "id"
        )
    ...
    async def import_value_type_container_types(self) -> None:
        ...
        self._value_type_container_types = self.parse_list_to_dict(
            json_data["valueTypeContainerTypes"], "id"
        )
    ...
    def parse_list_to_dict(
        self, dictionary_list: list[dict[str, Any]], key: str
    ) -> dict[str, dict]:
        """
