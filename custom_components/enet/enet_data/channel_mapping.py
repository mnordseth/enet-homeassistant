CHANNEL_TYPE_CONFIGURATION = {
    "CT_1F02": {
        ...
        "deviceParameters": {"applicationMode": "PT_INDA.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F13": {
        "inputDeviceFunctions": {},
        "outputDeviceFunctions": {
        ...
        "deviceParameters": {"applicationMode": "PT_INScS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F11": {
        "inputDeviceFunctions": {},
        "outputDeviceFunctions": {"buttonRocker": "FT_INGBRS.GBR"},
        "deviceParameters": {"applicationMode": "PT_INGBRS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F05": {
        "inputDeviceFunctions": {
        ...
        "deviceParameters": {"applicationMode": "PT_INSArGO.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F03": {
        "inputDeviceFunctions": {
            "upDown": "FT_INBA.MUD",
    ...
    "CT_1F01": {
        ...
        "deviceParameters": {"applicationMode": "PT_INSA.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F01_DUMMY": {
        "inputDeviceFunctions": {
            "onOff": "FT_INSA.SOO",
    ...
    "CT_1F1B": {
        ...
        "deviceParameters": {"applicationMode": "PT_INMOVS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F08": {
        "inputDeviceFunctions": {
            "onOff": "FT_INSAv2.SOO",
    ...
    "CT_1F12": {
        ...
        "deviceParameters": {"applicationMode": "PT_INLS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F1E": {
        "inputDeviceFunctions": {},
        "outputDeviceFunctions": {
        ...
        "deviceParameters": {"applicationMode": "PT_INBS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F0B": {
        "inputDeviceFunctions": {
    ...
    "CT_1F0C": {
        ...
        "deviceParameters": {"applicationMode": "PT_INLAv2_DA.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F0E": {
        "inputDeviceFunctions": {
            "onOff": "FT_INLNS3.SOO",
        ...
        "outputDeviceFunctions": {"blockedState": "FT_INLNS3.IBFS"},
        "deviceParameters": {"applicationMode": "PT_INLNS3.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F10": {
        "inputDeviceFunctions": {
    ...
    "CT_1F0D": {
        ...
        "deviceParameters": {"applicationMode": "PT_INLAv2_SAS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F0E_SA": {
        "inputDeviceFunctions": {
        ...
        "outputDeviceFunctions": {"blockedState": "FT_INLNS3_SA.IBFS"},
        "deviceParameters": {"applicationMode": "PT_INLNS3_SA.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F19": {
        "inputDeviceFunctions": {},
        "outputDeviceFunctions": {
        ...
        "deviceParameters": {"applicationMode": "PT_INES.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F18": {
        "inputDeviceFunctions": {},
        "outputDeviceFunctions": {
        ...
        "deviceParameters": {"applicationMode": "PT_INThScS.APPLICATION_MODE_DUMMY"},
    },
    "CT_1F09": {
        "inputDeviceFunctions": {
            "onOff": "FT_INSAv3.SOO",
